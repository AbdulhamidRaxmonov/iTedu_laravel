                ...
                <tbody>
                    ...
                    @foreach($cats as $cat)
                     <tr>
                         ...
                         <td>{{$cat->name}}</td>
                         <td>
                             <a href="{{route('category.delete', $cat->id)}}" class="btn btn-danger btn-sm btn-oval" title="Delete" onclick="return confirm('You want to delete?')">
                                 <i class="fa fa-trash"></i>
                             </a>
                             <a href="{{route('category.edit', $cat->id)}}" class="btn btn-success btn-sm btn-oval" title="Edit">
