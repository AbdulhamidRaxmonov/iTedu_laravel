...
@endsection
@section('content')
   <form action="{{route('social.store', $social->id)}}" method="POST">
       @csrf
       @method('PATCH')
            ...
            <div class="row">
                ...
                @endcomponent
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="name" name="name" required autofocus value="{{$social->name}}">
                        </div>
                   </div>
                   <div class="form-group row">
                        <label for="icon" class="col-sm-3">Icon <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="icon" name="icon" required  value="{{$social->icon}}">
                        </div>
                   </div>
                   <div class="form-group row">
                        <label for="url" class="col-sm-3">URL <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="url" name="url" required value="{{$social->url}}">
                        </div>
                   </div>
                </div>
            </div>
