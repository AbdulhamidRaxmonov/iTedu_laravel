        ...
        @endcomponent
            <div class="row">
                <div class="col-sm-7">
                   ...
                   <div class="form-group row">
                        <label for="password" class="col-sm-3">Password</span></label>
                        <div class="col-sm-9">
                ...
                <div class="col-sm-5">
                <div class="form-group row">
                        <label for="photo" class="col-sm-2">Photo <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            <input type="file" class="form-control" id="photo" name="photo" onchange="preview(event)" accept="image/*">
                            <div style="margin-top: 9px">
                            <img src="{{asset($user->photo)}}" alt="" id="img" width="120px">  
                           </div>
                        </div>
                   </div>
                </div>
